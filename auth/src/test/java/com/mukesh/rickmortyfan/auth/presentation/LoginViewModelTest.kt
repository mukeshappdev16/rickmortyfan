...
class LoginViewModelTest {
    ...
    @Test
    fun `login should emit success state when use case returns success`() =
        runTest {
            // Given
    ...
    @Test
    fun `login should emit error state when email is empty`() =
        runTest {
            // When
    ...
    @Test
    fun `login should emit error state when use case returns error`() =
        runTest {
            // Given
            val email = "test@example.com"
            val password = "password123"
