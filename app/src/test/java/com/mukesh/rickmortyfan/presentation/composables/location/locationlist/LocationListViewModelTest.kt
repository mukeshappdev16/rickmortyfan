...
class LocationListViewModelTest {
    ...
    @Test
    fun `getLocations should update state with success when network is available`() =
        runTest {
            // Given
            val locations =
                Locations(
    ...
    @Test
    fun `getLocations should update state with noInternet when network is unavailable`() =
        runTest {
            // Given
    ...
    @Test
    fun `getLocations should update state with error when use case returns error`() =
        runTest {
            // Given
