...
class GetMultipleEpisodesUseCase
    @Inject
    constructor(private val characterRepository: EpisodesRepository) {
        operator fun invoke(ids: List<String>): Flow<Resource<List<Episode>>> =
            flow {
                try {
